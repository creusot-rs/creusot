...
///
/// ```rust
/// use creusot_std::{ghost::local_invariant::{declare_namespace, Namespace}, logic::Set, prelude::*};
/// declare_namespace! { A }
///
...
impl Tokens<'_> {
    ...
    /// # Example
    /// ```
    /// # use creusot_std::{ghost::local_invariant::Tokens, prelude::*};
    ...
    ///
    /// ```
    /// # use creusot_std::{ghost::local_invariant::{declare_namespace, Tokens}, prelude::*};
