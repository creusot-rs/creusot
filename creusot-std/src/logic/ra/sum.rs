...
///
/// This requires either the authority or the fragment to be in the `Left` state
/// (the other will be implied as they must always be in the same state).
...
/// authority/fragment pair of [`Sum`]s.
///
/// This requires either the authority or the fragment to be in the `Right` state
/// (the other will be implied as they must always be in the same state).
