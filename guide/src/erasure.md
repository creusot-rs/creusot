...
- [`Perm::as_ref(ptr)`](https://doc.creusot.rs/creusot_std/ghost/struct.Perm.html#method.as_ref) erases to `&*ptr` (pointer-to-reference coercion).
- [`Perm::as_mut(ptr)`](https://doc.creusot.rs/creusot_std/ghost/struct.Perm.html#method.as_mut) erases to `&mut *ptr` (pointer-to-reference coercion).
- [`Perm::from_ref(r)`](https://doc.creusot.rs/creusot_std/ghost/struct.Perm.html#method.from_ref) erases to `r as *const T` (reference-to-pointer coercion).
- [`Perm::from_mut(r)`](https://doc.creusot.rs/creusot_std/ghost/struct.Perm.html#method.from_mut) erases to `r as *mut T` (reference-to-pointer coercion).
...
[ghost-split]: https://doc.creusot.rs/creusot_std/ghost/struct.Ghost.html#method.split
[ghost-borrow]: https://doc.creusot.rs/creusot_std/ghost/struct.Ghost.html#method.borrow
