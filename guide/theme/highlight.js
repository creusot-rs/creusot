...
},O=S("//","$"),M=S("/\\*","\\*/"),R=S("#","$");var I=Object.freeze({
...
;e=_(S.subLanguage,R,!0,O[S.subLanguage]),O[S.subLanguage]=e._top
...
;const N=Z(x);let v="",S=r||N;const O={},M=new f.__emitter(f);(()=>{const e=[]
...
value:v,relevance:I,illegal:!1,_emitter:M,_top:S}}catch(t){
