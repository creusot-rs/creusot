...
- [Allow naming of result in `#[ensures]`](https://github.com/creusot-rs/creusot/pull/1973)
- [cargo-creusot: Add `--why3find-arg` and `--dry-run` options](https://github.com/creusot-rs/creusot/pull/2007)

### `creusot-std`

#### Added

- [Add `SendPerm` and `SyncPerm` to allow implementing `Send` and `Sync` on `Perm` in external libraries](https://github.com/creusot-rs/creusot/pull/2030)
- [Add `sub_logic` law: `ptr - (ptr + ofs) == -ofs`](https://github.com/creusot-rs/creusot/pull/2021)
- [Define a `Positive` type for strictly positive integers](https://github.com/creusot-rs/creusot/pull/2017)
- [Add extern spec for `From` conversions between `&[T]`, `Box<[T]>` and `Vec<T>`](https://github.com/creusot-rs/creusot/pull/2010)
- [Add extern spec for `Into`, and `From` on `Box`, `Option`, and integers](https://github.com/creusot-rs/creusot/pull/2008)
- [Add extern spec for `std::hint::select_unpredictable`](https://github.com/creusot-rs/creusot/pull/1970)
- [Specify `<*const T>::cast_mut` and `<*mut T>::cast_const`](https://github.com/creusot-rs/creusot/pull/1968)
- [Add `fmap::Iter`](https://github.com/creusot-rs/creusot/pull/1964)
- [Add `Seq::{as_refs, as_muts, remove, extract, extend, eq_ref}` and refactor `Seq` iterators](https://github.com/creusot-rs/creusot/pull/1962)
- [Add extern specs for arithmetic operations](https://github.com/creusot-rs/creusot/pull/1960)
- [Add `AddAssign`, etc. for `Int`](https://github.com/creusot-rs/creusot/pull/1958)
- [Add extern spec for `Bound::copied`](https://github.com/creusot-rs/creusot/pull/1956)
- [Add pointer specs needed to verify slices](https://github.com/creusot-rs/creusot/pull/1534)
- [Cancelation and removing fragments](https://github.com/creusot-rs/creusot/pull/1996)
- [`RelAcq` version of `AtomicPtr`](https://github.com/creusot-rs/creusot/pull/1988)
- [Add other atomic types and update MP examples](https://github.com/creusot-rs/creusot/pull/1985)
- [Re-work the API for atomics](https://github.com/creusot-rs/creusot/pull/1982)
- ["Options" version of the relacq message passing example.](https://github.com/creusot-rs/creusot/pull/1977)
- [Add message passing example, in a relaxed memory setting](https://github.com/creusot-rs/creusot/pull/1976)
- [New version of message passing sc, using options instead of a big sum type](https://github.com/creusot-rs/creusot/pull/1974)
- [Add a sequentially-consistent message-passing example](https://github.com/creusot-rs/creusot/pull/1955)
- [Some improvement to resource algebras](https://github.com/creusot-rs/creusot/pull/1954)

#### Changed / Fixed

- [Rename `AddLogic::add` to `AddLogic::add_logic`, etc.](https://github.com/creusot-rs/creusot/pull/1959)
- [Fix a few soundness bugs discovered at VerifyThis.](https://github.com/creusot-rs/creusot/pull/2029)
- [Fix spec of `offset_logic`](https://github.com/creusot-rs/creusot/pull/2020)
- [Make `Tokens::split` take full ownership of `self`](https://github.com/creusot-rs/creusot/pull/2016)
- [Use absolute paths in `ord_laws_impl!`](https://github.com/creusot-rs/creusot/pull/2011)
- [Fix derive `Clone` for structs with no fields](https://github.com/creusot-rs/creusot/pull/1993)
- [Mapping should be contravariant](https://github.com/creusot-rs/creusot/pull/1981)
- [Fix extern spec of `RangeBounds`](https://github.com/creusot-rs/creusot/pull/1980)
- [Allow `Int::ne` in ghost code](https://github.com/creusot-rs/creusot/pull/1961)
- [doc: Fix doc links generated by extern_spec](https://github.com/creusot-rs/creusot/pull/1963)
- [Remove some manual tactics in `creusot-std`](https://github.com/creusot-rs/creusot/pull/1995)

### Compiler fixes

- [Add some spans and labels to slice primitives](https://github.com/creusot-rs/creusot/pull/2032)
- [Fix dependency tracking for polymorphic recursive functions](https://github.com/creusot-rs/creusot/pull/2024)
- [The `as` operator on integers should not add a precondition.](https://github.com/creusot-rs/creusot/pull/2005)
- [Normalize field types in `resolve` and `ty_inv`](https://github.com/creusot-rs/creusot/pull/1987)
- [Add check for opaque types](https://github.com/creusot-rs/creusot/pull/1984)
- [Improve erasure of function values](https://github.com/creusot-rs/creusot/pull/1971)
- [Improve erasure](https://github.com/creusot-rs/creusot/pull/1969): erase `Ghost` in result type to `()` and handle assignments
- [Fix termination checker](https://github.com/creusot-rs/creusot/pull/1967)
- [Fix a crash when typechecking snapshots failed](https://github.com/creusot-rs/creusot/pull/1953)
- [Use unique identifier for `--package` option of cargo creusot](https://github.com/creusot-rs/creusot/pull/2041)
- [Read `CREUSOT_STD` environment variable in `patch_dep` function](https://github.com/creusot-rs/creusot/pull/2033)
- [Improvements for bitwise mode](https://github.com/creusot-rs/creusot/pull/2045)

### Toolchain

- [Upgrade Why3find](https://github.com/creusot-rs/creusot/pull/2001)
- [Upgrade Why3](https://github.com/creusot-rs/creusot/pull/1978)
- [Update toolchain to nightly-2026-02-25](https://github.com/creusot-rs/creusot/pull/1952)
- [Pull why3find from creusot-rs mirror](https://github.com/creusot-rs/creusot/pull/2047)

### Communication

- [New domain creusot.rs](https://github.com/creusot-rs/creusot/pull/2000)
