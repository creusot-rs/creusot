...
#[requires(f.precondition((1i32,), mode!()))]
#[ensures(f.postcondition((1i32,), result, mode!()))]
#[check(ghost)]
...
#[requires(f.precondition((1i32,), mode!()))]
#[ensures(exists<f2> f.postcondition_mut((1i32,), f2, result, mode!()))]
#[check(ghost)]
...
#[requires(f.precondition((1i32,), mode!()))]
#[ensures(f.postcondition_once((1i32,), result, mode!()))]
#[check(ghost)]
