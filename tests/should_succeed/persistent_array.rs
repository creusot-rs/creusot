...
pub mod implementation {
    ...
    type LogicId = Snapshot<pcell::Id>;
    ...
    struct TokensMapInner {
        ...
        values: Snapshot<Mapping<pcell::Id, Seq<Value>>>,
        rank: Snapshot<Mapping<pcell::Id, Int>>,
        length: Snapshot<Int>,
    }
    ...
    impl TokensMap {
        ...
        #[open(self)]
        #[requires(inv(self))]
        #[ensures(forall<a: _> self.contains(a) ==> result == a.view().len())]
    ...
    impl PersistentArray {
        ...
        #[ensures(forall<a: _> (*tokens).contains(a) == (^tokens).contains(a))]
        ...
        /// See the [safety section](PersistentArray#safety) on the type documentation.
        #[requires(tokens.0.own_map.contains(Snapshot::new(inner.view().id())))]
        #[ensures(forall<id: _> (*tokens).0.own_map.contains(id) == (^tokens).0.own_map.contains(id))]
