...
use tool_lib::dataflow::Analysis;
use tool_lib::dataflow::{Results, ResultsCursor};
...
impl Dir for tool_lib::dataflow::Forward {
    fn is_forward() -> bool {
        true
    }
}

impl Dir for tool_lib::dataflow::Backward {
    fn is_forward() -> bool {
        false
    }
}
