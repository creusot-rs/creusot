...
fn cterm_to_ast(t: &ConcreteTerm) -> Expr {
    match t {
        ...
        ConcreteTerm::Proj { name, value } => match (&**name, &**value) {
            ...
            ("mach.int.Int32Gen.int32'int", ConcreteTerm::Integer(n)) => lit(&n.int_value, LitKind::Integer, Some("i32")),
            ("mach.int.Int64Gen.int64'int", ConcreteTerm::Integer(n)) => lit(&n.int_value, LitKind::Integer, Some("i64")),
