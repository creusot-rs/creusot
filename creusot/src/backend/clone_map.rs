...
impl PreludeModule {
    pub fn qname(&self) -> QName {
        match self {
            PreludeModule::Float32 => QName::from_string("prelude.prelude.prelude.Float32").unwrap(),
            PreludeModule::Float64 => QName::from_string("prelude.prelude.prelude.Float64").unwrap(),
            PreludeModule::Int => QName::from_string("prelude.prelude.prelude.Int").unwrap(),
            PreludeModule::Int8 => QName::from_string("prelude.prelude.prelude.Int8").unwrap(),
            PreludeModule::Int16 => QName::from_string("prelude.prelude.prelude.Int16").unwrap(),
            PreludeModule::Int32 => QName::from_string("prelude.prelude.prelude.Int32").unwrap(),
            PreludeModule::Int64 => QName::from_string("prelude.prelude.prelude.Int64").unwrap(),
            PreludeModule::Int128 => QName::from_string("prelude.prelude.prelude.Int128").unwrap(),
            PreludeModule::UInt8 => QName::from_string("prelude.prelude.prelude.UInt8").unwrap(),
            PreludeModule::UInt16 => QName::from_string("prelude.prelude.prelude.UInt16").unwrap(),
            PreludeModule::UInt32 => QName::from_string("prelude.prelude.prelude.UInt32").unwrap(),
            PreludeModule::UInt64 => QName::from_string("prelude.prelude.prelude.UInt64").unwrap(),
            PreludeModule::UInt128 => QName::from_string("prelude.prelude.prelude.UInt128").unwrap(),
            PreludeModule::Char => QName::from_string("prelude.prelude.prelude.Char").unwrap(),
            PreludeModule::Opaque => QName::from_string("prelude.prelude.prelude.Opaque").unwrap(),
            PreludeModule::Ref => QName::from_string("Ref").unwrap(),
            PreludeModule::Seq => QName::from_string("prelude.prelude.prelude.Seq").unwrap(),
            PreludeModule::Type => QName::from_string("Type").unwrap(),
            PreludeModule::Isize => QName::from_string("prelude.prelude.prelude.IntSize").unwrap(),
            PreludeModule::Usize => QName::from_string("prelude.prelude.prelude.UIntSize").unwrap(),
            PreludeModule::Bool => QName::from_string("prelude.prelude.prelude.Bool").unwrap(),
            PreludeModule::Borrow => QName::from_string("prelude.prelude.prelude.Borrow").unwrap(),
            PreludeModule::Slice => QName::from_string("prelude.prelude.prelude.Slice").unwrap(),
            PreludeModule::Intrinsic => QName::from_string("prelude.prelude.prelude.Intrinsic").unwrap(),
        }
    }
}
