...
use rustc_middle::{
    ...
    ty::{
        ...
        AliasTy, DefIdTree, EarlyBinder, FloatTy, GenericArg, List, SubstsRef, Ty, TyCtxt, TyKind,
        TypeFoldable, TypeSuperVisitable, TypeVisitor, UintTy,
    },
};
use rustc_resolve::Namespace;
use rustc_span::{Symbol, DUMMY_SP};
use rustc_type_ir::{AliasKind, IntTy, RegionKind};
...
fn cloneable_name(ctx: &TranslationCtx, def_id: DefId, interface: CloneDepth) -> QName {
    ...
    match util::item_type(ctx.tcx, def_id) {
        Logic | Predicate | Impl | Constant | Field => match interface {
            ...
            CloneDepth::Deep => module_name(ctx.tcx, def_id).into(),
        },
