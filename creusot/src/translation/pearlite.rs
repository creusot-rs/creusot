...
use rustc_middle::{
    ...
    ty::{
        self, int_ty, uint_ty, CanonicalUserType, GenericArgs, GenericArgsRef, Ty, TyCtxt, TyKind, TypeFoldable, TypeVisitable, TypeVisitableExt, TypingEnv, UserTypeKind, adjustment::PointerCoercion, },
};
