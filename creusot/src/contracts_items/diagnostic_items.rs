...
contracts_items! {{
    ...
    fn PtrOwn::from_ref                  ["ptr_own_from_ref"]
        is_ptr_own_from_ref             get_ptr_own_from_ref
    fn PtrOwn::from_mut                  ["ptr_own_from_mut"]
        is_ptr_own_from_mut             get_ptr_own_from_mut
